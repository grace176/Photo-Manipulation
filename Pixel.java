...
public class Pixel implements Comparable<Pixel> {
    ...
    public int[] getComponents() {
        return rgb; // Implement this method
    }
    ...
    public int distance(Pixel px) {
        return Math.abs(rgb[0] - px.rgb[0]) +
                Math.abs(rgb[1] - px.rgb[1]) + Math.abs(rgb[2] - rgb[2]); // Implement this method
    }
    ...
    public String toString() {
        return "(" + rgb[0] + ", " + rgb[1] + ", " + rgb[2] + ")"; // Implement this method
    }
    ...
    public boolean equals(Pixel px) {
        return getRed() == px.getRed() &&
                getGreen() == px.getGreen() &&
                getBlue() == px.getBlue(); // Implement this method
    }
